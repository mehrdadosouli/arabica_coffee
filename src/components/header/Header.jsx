...
export default function Header() {
  ...
  return (
    <header className="w-full lg:w-11/12 h-16 lg:h-24 fixed lg:fixed top-0 z-50 px-4 lg:px-8 lg:mt-9 bg-bgItemLightColor dark:bg-bgItemDarkColor lg:bg-[#00000080] dark:lg:bg-[#00000080] lg:backdrop-blur-sm lg:rounded-3xl">
      {/* mobile */}
      <div className="lg:h-auto h-16 flex flex-row justify-between items-center">
        <div onClick={() => hamburgerMenuBtn()} className="lg:hidden text-textPrimaryLightColor dark:text-textPrimaryDarkColor hover:text-primaryColor dark:hover:text-secondaryColor duration-300 cursor-pointer" >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
        ...
        {/* logo */}
        <img src={logo2} alt="arabica logo" className="lg:hidden h-10 object-contain cursor-pointer" />
        {/* cart icon */}
        <span
          onClick={() => hamburgerCartBtn()}
          className="lg:hidden text-textPrimaryLightColor dark:text-textPrimaryDarkColor hover:text-primaryColor dark:hover:text-secondaryColor duration-300 cursor-pointer"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
    ...
    <div className="md:flex md:flex-row">
      <div
        ...
        >
          <div className="w-2/3 lg:w-full h-screen lg:h-24 px-4 lg:px-0 z-10 bg-bgItemLightColor dark:bg-bgItemDarkColor lg:bg-transparent dark:lg:bg-transparent flex flex-col lg:flex-row justify-start lg:justify-between items-start lg:items-center gap-4 lg:gap-0">
            {/* logo and menu */}
            <div className="w-full lg:w-auto flex flex-col lg:flex-row justify-start items-center gap-4 lg:gap-9">
              ...
              {/* menu */}
              <ul className="w-full lg:w-auto text-base lg:text-xl font-normal dark:text-textPrimaryDarkColor md:text-textPrimaryDarkColor flex flex-col lg:flex-row justify-start items-start lg:items-center gap-2.5 lg:gap-9 duration-300 *:duration-300">
                {itemMenu.map((item) => (
                  <Link
                    key={item.page}
                    to={item.link}
