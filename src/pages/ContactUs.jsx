...
export default function ContactUs() {
  ...
  return (
    <div className="size-full relative">
      ...
      <h1 className='w-fit md:text-5xl text-3xl text-orange-500 font-bold drop-shadow-md absolute top-[30vh] left-0 right-0 mx-auto animate-bounce'>تماس با قهوه عربیکا</h1>
